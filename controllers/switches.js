...
const controlSwitch = async (req, res) => {
  ...
  try {
    const response = await apiClient.post(`services/switch/${service}`, {
    ...
    console.log(`Switch ${deviceName}: '${action}' command sent successfully.`);
